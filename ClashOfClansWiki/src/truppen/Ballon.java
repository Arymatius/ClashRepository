...
public class Ballon extends FragmentActivity implements ActionBar.TabListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		viewPager = (ViewPager) findViewById(R.id.ballon_pager);
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public SectionsPagerAdapter(FragmentManager fragmentManager) {
			...
			fragments.add(new BallonLevelFragment());
			fragments.add(new BallonTabelleFragment());
