...
import truppenTabs.MauerbrecherLevelFragment;
import truppenTabs.MauerbrecherTabelleFragment;
...
public class Mauerbrecher extends FragmentActivity implements ActionBar.TabListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_mauerbrecher);
		...
		viewPager = (ViewPager) findViewById(R.id.mauerbrecher_pager);
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public SectionsPagerAdapter(FragmentManager fragmentManager) {
			...
			fragments.add(new MauerbrecherLevelFragment());
			fragments.add(new MauerbrecherTabelleFragment());
