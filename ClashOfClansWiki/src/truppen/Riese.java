...
import truppenTabs.RieseLevelFragment;
import truppenTabs.RieseTabelleFragment;
...
public class Riese extends FragmentActivity implements ActionBar.TabListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_riese);
		...
		viewPager = (ViewPager) findViewById(R.id.riese_pager);
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public SectionsPagerAdapter(FragmentManager fragmentManager) {
			...
			fragments.add(new RieseLevelFragment());
			fragments.add(new RieseTabelleFragment());
