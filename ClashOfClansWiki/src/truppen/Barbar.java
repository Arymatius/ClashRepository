...
import truppenTabs.BarbarLevelFragment;
import truppenTabs.BarbarTabelleFragment;
...
public class Barbar extends FragmentActivity implements ActionBar.TabListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_barbar);
		...
		viewPager = (ViewPager) findViewById(R.id.barbar_pager);
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public SectionsPagerAdapter(FragmentManager fragmentManager) {
			...
			fragments.add(new BarbarLevelFragment());
			fragments.add(new BarbarTabelleFragment());
