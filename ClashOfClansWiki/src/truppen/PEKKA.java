...
import truppenTabs.PEKKALevelFragment;
import truppenTabs.PEKKATabelleFragment;
...
public class PEKKA extends FragmentActivity implements ActionBar.TabListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_pekk);
		...
		viewPager = (ViewPager) findViewById(R.id.pekka_pager);
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public SectionsPagerAdapter(FragmentManager fragmentManager) {
			...
			fragments.add(new PEKKALevelFragment());
			fragments.add(new PEKKATabelleFragment());
