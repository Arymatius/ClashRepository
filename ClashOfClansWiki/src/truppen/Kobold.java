...
import truppenTabs.KoboldLevelFragment;
import truppenTabs.KoboldTabelleFragment;
...
public class Kobold extends FragmentActivity implements ActionBar.TabListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		viewPager = (ViewPager) findViewById(R.id.kobold_pager);
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public SectionsPagerAdapter(FragmentManager fragmentManager) {
			...
			fragments.add(new KoboldLevelFragment());
			fragments.add(new KoboldTabelleFragment());
