...
import truppenTabs.BogenschuetzeLevelFragment;
import truppenTabs.BogenschuetzeTabelleFragment;
...
public class Bogenschuetze extends FragmentActivity implements ActionBar.TabListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_bogenschuetze);
		...
		viewPager = (ViewPager) findViewById(R.id.bogenschuetze_pager);
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public SectionsPagerAdapter(FragmentManager fragmentManager) {
			...
			fragments.add(new BogenschuetzeLevelFragment());
			fragments.add(new BogenschuetzeTabelleFragment());
