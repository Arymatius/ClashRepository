...
import truppenTabs.DracheLevelFragment;
import truppenTabs.DracheTabelleFragment;
...
public class Drache extends FragmentActivity implements ActionBar.TabListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_drache);
		...
		viewPager = (ViewPager) findViewById(R.id.drache_pager);
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public SectionsPagerAdapter(FragmentManager fragmentManager) {
			...
			fragments.add(new DracheLevelFragment());
			fragments.add(new DracheTabelleFragment());
