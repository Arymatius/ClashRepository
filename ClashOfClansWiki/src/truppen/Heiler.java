...
import truppenTabs.HeilerLevelFragment;
import truppenTabs.HeilerTabelleFragment;
...
public class Heiler extends FragmentActivity implements ActionBar.TabListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_heiler);
		...
		viewPager = (ViewPager) findViewById(R.id.heiler_pager);
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public SectionsPagerAdapter(FragmentManager fragmentManager) {
			...
			fragments.add(new HeilerLevelFragment());
			fragments.add(new HeilerTabelleFragment());
