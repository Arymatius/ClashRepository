...
import truppenTabs.MagierLevelFragment;
import truppenTabs.MagierTabelleFragment;
...
public class Magier extends FragmentActivity implements ActionBar.TabListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_magier);
		...
		viewPager = (ViewPager) findViewById(R.id.magier_pager);
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public SectionsPagerAdapter(FragmentManager fragmentManager) {
			...
			fragments.add(new MagierLevelFragment());
			fragments.add(new MagierTabelleFragment());
