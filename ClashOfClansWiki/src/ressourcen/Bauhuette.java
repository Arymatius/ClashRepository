...
import ressourcenTabs.BauhuetteLevelFragment;
import ressourcenTabs.BauhuetteTabelleFragment;
...
public class Bauhuette extends FragmentActivity implements ActionBar.TabListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_bauhuette);
		...
		viewPager = (ViewPager) findViewById(R.id.bauhuette_pager);
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public SectionsPagerAdapter(FragmentManager fragmentManager) {
			...
			fragments.add(new BauhuetteLevelFragment());
			fragments.add(new BauhuetteTabelleFragment());
