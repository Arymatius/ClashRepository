...
import ressourcenTabs.BFDELevelFragment;
import ressourcenTabs.BFDETabelleFragment;
...
public class BFDE extends FragmentActivity implements ActionBar.TabListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_bfde);
		...
		viewPager = (ViewPager) findViewById(R.id.bfde_pager);
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public SectionsPagerAdapter(FragmentManager fragmentManager) {
			...
			fragments.add(new BFDELevelFragment());
			fragments.add(new BFDETabelleFragment());
