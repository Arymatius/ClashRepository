...
import ressourcenTabs.ElexierSammlerLevelFragment;
import ressourcenTabs.ElexierSammlerTabelleFragment;
...
public class ElexierSammler extends FragmentActivity implements ActionBar.TabListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_elexier_sammler);
		...
		viewPager = (ViewPager) findViewById(R.id.elexierSammler_pager);
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public SectionsPagerAdapter(FragmentManager fragmentManager) {
			...
			fragments.add(new ElexierSammlerLevelFragment());
			fragments.add(new ElexierSammlerTabelleFragment());
