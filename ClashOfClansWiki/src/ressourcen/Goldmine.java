...
import ressourcenTabs.GoldmineLevelFragment;
import ressourcenTabs.GoldmineTabelleFragment;
...
public class Goldmine extends FragmentActivity implements ActionBar.TabListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		viewPager = (ViewPager) findViewById(R.id.goldmine_pager);
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public SectionsPagerAdapter(FragmentManager fragmentManager) {
			...
			fragments.add(new GoldmineLevelFragment());
			fragments.add(new GoldmineTabelleFragment());
