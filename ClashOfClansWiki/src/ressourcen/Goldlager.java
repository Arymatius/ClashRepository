...
import ressourcenTabs.GoldLagerLevelFragment;
import ressourcenTabs.GoldLagerTabelleFragment;
...
public class Goldlager extends FragmentActivity implements ActionBar.TabListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_goldlager);
		...
		viewPager = (ViewPager) findViewById(R.id.goldlager_pager);
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public SectionsPagerAdapter(FragmentManager fragmentManager) {
			...
			fragments.add(new GoldLagerLevelFragment());
			fragments.add(new GoldLagerTabelleFragment());
