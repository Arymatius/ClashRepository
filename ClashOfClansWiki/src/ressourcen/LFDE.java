...
import ressourcenTabs.LFDELevelFragment;
import ressourcenTabs.LFDETabelleFragment;
...
public class LFDE extends FragmentActivity implements ActionBar.TabListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_lfde);
		...
		viewPager = (ViewPager) findViewById(R.id.lfde_pager);
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public SectionsPagerAdapter(FragmentManager fragmentManager) {
			...
			fragments.add(new LFDELevelFragment());
			fragments.add(new LFDETabelleFragment());
