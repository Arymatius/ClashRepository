...
import armeeTabs.KaserneLevelFragment;
import armeeTabs.KaserneTabelleFragment;

public class Kaserne extends FragmentActivity implements ActionBar.TabListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_kaserne);
		...
		viewPager = (ViewPager) findViewById(R.id.kaserne_pager);
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public SectionsPagerAdapter(FragmentManager fragmentManager) {
			...
			fragments.add(new KaserneLevelFragment());
			fragments.add(new KaserneTabelleFragment());
