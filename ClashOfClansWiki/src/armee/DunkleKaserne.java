...
import armeeTabs.DunkleKaserneLevelFragment;
import armeeTabs.DunkleKaserneTabelleFragment;

public class DunkleKaserne extends FragmentActivity implements ActionBar.TabListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_dunkle_kaserne);
		...
		viewPager = (ViewPager) findViewById(R.id.dkaserne_pager);
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public SectionsPagerAdapter(FragmentManager fragmentManager) {
			...
			fragments.add(new DunkleKaserneLevelFragment());
			fragments.add(new DunkleKaserneTabelleFragment());
