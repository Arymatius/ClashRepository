...
import armeeTabs.LaborLevelFragment;
import armeeTabs.LaborTabelleFragment;

public class Labor extends FragmentActivity implements ActionBar.TabListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		viewPager = (ViewPager) findViewById(R.id.labor_pager);
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public SectionsPagerAdapter(FragmentManager fragmentManager) {
			...
			fragments.add(new LaborLevelFragment());
			fragments.add(new LaborTabelleFragment());
