...
import armeeTabs.ADBOKLevelFragment;
import armeeTabs.ADBOKTabelleFragment;

public class ADBOK extends FragmentActivity implements ActionBar.TabListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_adbok);
		...
		viewPager = (ViewPager) findViewById(R.id.adbok_pager);
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public SectionsPagerAdapter(FragmentManager fragmentManager) {
			...
			fragments.add(new ADBOKLevelFragment());
			fragments.add(new ADBOKTabelleFragment());
