...
import armeeTabs.ArmeeLagerLevelFragment;
import armeeTabs.ArmeeLagerTabelleFragment;

public class Armeelager extends FragmentActivity implements ActionBar.TabListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_armeelager);
		...
		viewPager = (ViewPager) findViewById(R.id.armeelager_pager);
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public SectionsPagerAdapter(FragmentManager fragmentManager) {
			...
			fragments.add(new ArmeeLagerLevelFragment());
			fragments.add(new ArmeeLagerTabelleFragment());
