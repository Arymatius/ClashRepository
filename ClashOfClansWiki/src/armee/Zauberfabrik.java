...
import armeeTabs.ZauberfabrikLevelFragment;
import armeeTabs.ZauberfabrikTabelleFragment;

public class Zauberfabrik extends FragmentActivity implements ActionBar.TabListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_zauberfabrik);
		...
		viewPager = (ViewPager) findViewById(R.id.zauberfabrik_pager);
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public SectionsPagerAdapter(FragmentManager fragmentManager) {
			...
			fragments.add(new ZauberfabrikLevelFragment());
			fragments.add(new ZauberfabrikTabelleFragment());
