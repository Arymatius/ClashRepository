...
import armeeTabs.ADBKLevelFragment;
import armeeTabs.ADBKTabelleFragment;

public class ADBK extends FragmentActivity implements ActionBar.TabListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_adbk);
		...
		viewPager = (ViewPager) findViewById(R.id.adbk_pager);
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public SectionsPagerAdapter(FragmentManager fragmentManager) {
			...
			fragments.add(new ADBKLevelFragment());
			fragments.add(new ADBKTabelleFragment());
