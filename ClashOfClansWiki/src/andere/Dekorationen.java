...
import andereTabs.DekoLevelFragment;
import andereTabs.DekoTabelleFragment;
...
public class Dekorationen extends FragmentActivity implements ActionBar.TabListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_dekorationen);
		...
		viewPager = (ViewPager) findViewById(R.id.deko_pager);
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public SectionsPagerAdapter(FragmentManager fragmentManager) {
			...
			fragments.add(new DekoLevelFragment());
			fragments.add(new DekoTabelleFragment());
