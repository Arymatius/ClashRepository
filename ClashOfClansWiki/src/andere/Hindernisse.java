...
import andereTabs.HindernisseLevelFragment;
import andereTabs.HindernisseTabelleFragment;
...
public class Hindernisse extends FragmentActivity implements ActionBar.TabListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_hindernisse);
		...
		viewPager = (ViewPager) findViewById(R.id.hindernisse_pager);
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public SectionsPagerAdapter(FragmentManager fragmentManager) {
			...
			fragments.add(new HindernisseLevelFragment());
			fragments.add(new HindernisseTabelleFragment());
