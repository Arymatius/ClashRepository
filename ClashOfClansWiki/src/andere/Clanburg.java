...
import andereTabs.ClanburgLevelFragment;
import andereTabs.ClanburgTabelleFragment;
...
public class Clanburg extends FragmentActivity implements ActionBar.TabListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_clanburg);
		...
		viewPager = (ViewPager) findViewById(R.id.clanburg_pager);
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public SectionsPagerAdapter(FragmentManager fragmentManager) {
			...
			fragments.add(new ClanburgLevelFragment());
			fragments.add(new ClanburgTabelleFragment());
