...
import andereTabs.RathausLevelFragment;
import andereTabs.RathausTabelleFragment;
...
public class Rathaus extends FragmentActivity implements ActionBar.TabListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_rathaus);
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public SectionsPagerAdapter(FragmentManager fragmentManager) {
			...
			fragments.add(new RathausLevelFragment());
			fragments.add(new RathausTabelleFragment());
