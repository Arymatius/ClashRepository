...
import defenseTabs.VTLevelFragment;
import defenseTabs.VTTabelleFragment;
...
public class VerborgenerTesla extends FragmentActivity implements ActionBar.TabListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_verborgener_tesla);
		...
		viewPager = (ViewPager) findViewById(R.id.vt_pager);
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public SectionsPagerAdapter(FragmentManager fragmentManager) {
			...
			fragments.add(new VTLevelFragment());
			fragments.add(new VTTabelleFragment());
