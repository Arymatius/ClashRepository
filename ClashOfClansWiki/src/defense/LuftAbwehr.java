...
import defenseTabs.LuftLevelFragment;
import defenseTabs.LuftTabelleFragment;
...
public class LuftAbwehr extends FragmentActivity implements ActionBar.TabListener{
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public SectionsPagerAdapter(FragmentManager fragmentManager) {
			...
			fragments.add(new LuftLevelFragment());
			fragments.add(new LuftTabelleFragment());
