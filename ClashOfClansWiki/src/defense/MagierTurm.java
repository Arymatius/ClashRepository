...
import defenseTabs.MagierTurmLevelFragment;
import defenseTabs.MagierTurmTabelleFragment;
...
public class MagierTurm extends FragmentActivity implements ActionBar.TabListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_magier_turm);
		...
		viewPager = (ViewPager) findViewById(R.id.magierturm_pager);
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public SectionsPagerAdapter(FragmentManager fragmentManager) {
			...
			fragments.add(new MagierTurmLevelFragment());
			fragments.add(new MagierTurmTabelleFragment());
