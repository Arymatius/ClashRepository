...
import defenseTabs.X_BogenLevelFragment;
import defenseTabs.X_BogenTabelleFragment;
...
public class X_Bogen extends FragmentActivity implements ActionBar.TabListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_luft_abwehr);
		...
		viewPager = (ViewPager) findViewById(R.id.luft_pager);
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public SectionsPagerAdapter(FragmentManager fragmentManager) {
			...
			fragments.add(new X_BogenLevelFragment());
			fragments.add(new X_BogenTabelleFragment());
