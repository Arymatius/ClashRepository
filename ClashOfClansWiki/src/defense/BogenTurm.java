...
import defenseTabs.BogenLevelFragment;
import defenseTabs.BogenTabelleFragment;
...
public class BogenTurm extends FragmentActivity implements ActionBar.TabListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.bogen_turm);
		...
		viewPager = (ViewPager) findViewById(R.id.bogen_pager);
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public SectionsPagerAdapter(FragmentManager fragmentManager) {
			...
			fragments.add(new BogenLevelFragment());
			fragments.add(new BogenTabelleFragment());
