...
import defenseTabs.InfernoLevelFragment;
import defenseTabs.InfernoTabelleFragment;
...
public class InfernoTurm extends FragmentActivity implements ActionBar.TabListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_inferno_turm);
		...
		viewPager = (ViewPager) findViewById(R.id.inferno_pager);
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public SectionsPagerAdapter(FragmentManager fragmentManager) {
			...
			fragments.add(new InfernoLevelFragment());
			fragments.add(new InfernoTabelleFragment());
		...
		public CharSequence getPageTitle(int position) {
			...
			case 2:
				return getString(R.string.strategie).toUpperCase();
