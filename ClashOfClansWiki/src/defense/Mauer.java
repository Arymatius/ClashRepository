...
import defenseTabs.MauerLevelFragment;
import defenseTabs.MauerTabelleFragment;
...
public class Mauer extends FragmentActivity implements ActionBar.TabListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_mauer);
		...
		viewPager = (ViewPager) findViewById(R.id.mauer_pager);
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public SectionsPagerAdapter(FragmentManager fragmentManager) {
			...
			fragments.add(new MauerLevelFragment());
			fragments.add(new MauerTabelleFragment());
